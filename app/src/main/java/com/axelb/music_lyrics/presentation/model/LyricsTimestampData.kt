package com.axelb.music_lyrics.presentation.model

data class LyricsTimestampData(
  val timestampInMillis: Long = 0L,
  val lyrics: String = ""
) {
  companion object {
    fun getTheOtherSideLyrics(): List<LyricsTimestampData> {
      return listOf(
        LyricsTimestampData(
          8160,
